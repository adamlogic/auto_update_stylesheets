(function() {
  ...
  // once jQuery is loaded, start polling for stylesheet changes
  setTimeout(startPollingIfJQueryIsLoaded, 300);

  function startPollingIfJQueryIsLoaded() {
    if (typeof jQuery == 'undefined') {
      ...
      jQuery.autoUpdateStylesheets('toggle');
